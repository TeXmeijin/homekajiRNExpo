...
import { ActivityIndicator, Animated, Image, Pressable, StyleSheet, Text, View, ViewStyle, TextStyle, ImageStyle } from 'react-native';
import { COLORS } from '../constants/COLORS';
import { Task } from '../types/task';

export const TaskListItem = (props: { task: Task, fadeAnim: Animated.Value, isSaving: boolean, onPress: () => void }) => {
  return (
    <Pressable onPress={props.onPress} style={itemStyle}>
      ...
      <View style={style.statuses}>
        <ActivityIndicator style={style.status} size='large' color='#999' animating={props.isSaving}/>
